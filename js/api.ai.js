(function () {
     ...
     Defaults
    var CONTENT_TYPE = content-type=audiox-raw,+layout=(string)interleaved,+rate=(int)16000,+format=(string)S16LE,+channels=(int)1;
    ...
    ApiAi.prototype.init = function () {
        ...
        try {
            ...
            _this.audio_context = new AudioContext();
             ...
             Set media.webaudio.enabled = true (in aboutconfig) to fix this.
    ...
    ApiAi.prototype.startListening = function () {
        ...
        _this.ws.send({'timezone''AmericaNew_York', 'lang'' + _this.lang + ', 'sessionId'' + _this.sessionId + '});
        ...
        function _openWebSocket() {
            ...
            function _createWebSocket() {
                ...
                ws.onopen = function (e) {
                    ...
                    ws.send({'timezone''AmericaNew_York', 'lang''en'});
                 ...
                 Status codes
                 httptools.ietf.orghtmlrfc6455#section-7.4.1
                 1005
                 1006
